...
static const u8 sText_PkmnHealByPoison[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}\n heal it from poison!");
...
static const u8 sText_PkmnsXLostHPALittle[] = _("{B_ATK_NAME_WITH_PREFIX} lost HP due to\n {B_ATK_ABILITY}");
