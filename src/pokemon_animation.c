...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_BURMY_P]    = BACK_ANIM_H_SHAKE,
    [SPECIES_BURMY_S]    = BACK_ANIM_H_SHAKE,
    [SPECIES_BURMY_T]    = BACK_ANIM_H_SHAKE,
    [SPECIES_WORMADAM_P] = BACK_ANIM_V_SHAKE,
    [SPECIES_WORMADAM_S] = BACK_ANIM_V_SHAKE,
    [SPECIES_WORMADAM_T] = BACK_ANIM_V_SHAKE,
    ...
    [SPECIES_CHERRIM]    = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_SHELLOS_E]  = BACK_ANIM_H_SPRING,
    [SPECIES_GASTRODON_E]= BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_SHELLOS_W]  = BACK_ANIM_H_SPRING,
    [SPECIES_GASTRODON_W]= BACK_ANIM_SHRINK_GROW_VIBRATE,
