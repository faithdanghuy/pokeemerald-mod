const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
    ...
    [MOVE_HAMMER_ARM] =
    {
        .effect = EFFECT_LOWER_USER_SPEED_1,
        .power = 100,
        .type = TYPE_FIGHTING,
        .accuracy = 90,
        .pp = 10,
    ...
    [MOVE_VENOSHOCK] =
    {
        .effect = EFFECT_DOUBLE_POWER_IF_POISON,
        .power = 65,
        .type = TYPE_POISON,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_HEX] =
    {
        .effect = EFFECT_DOUBLE_POWER_IF_STATUS,
        .power = 65,
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = 10,
    ...
    [MOVE_BODY_PRESS] =
    {
        .effect = EFFECT_USE_DEFENSE_TO_ATTACK,
        .power = 80,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = 10,
