...
static const struct TrainerMonItemCustomMoves sParty_ShellyWeatherInstitute[] = {
    ...
    .moves = {MOVE_ENERGY_BALL, MOVE_SLUDGE_BOMB, MOVE_SHADOW_BALL, MOVE_SHINING_GLEAM},
    .abilityNums = 1
    },
    {
    .iv = 200,
    ...
    .moves = {MOVE_AIR_SLASH, MOVE_MOONBLAST, MOVE_THUNDER_WAVE, MOVE_EXTREME_SPEED},
    .abilityNums = 1
    },
    {
    .iv = 200,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .heldItem = ITEM_WISE_GLASSES,
    .moves = {MOVE_WILL_O_WISP, MOVE_SHADOW_BALL, MOVE_FLAMETHROWER, MOVE_ENERGY_BALL},
    .abilityNums = 0
    },
    {
    .iv = 250,
...
static const struct TrainerMonItemCustomMoves sParty_MaxieMtChimney[] = {
    ...
    .species = SPECIES_STARAPTOR,
    .heldItem = ITEM_SILK_SCARF,
    .moves = {MOVE_CLOSE_COMBAT, MOVE_TAKE_DOWN, MOVE_DUAL_WINGBEAT, MOVE_FACADE},
    .abilityNums = 0
    },
    {
    .iv = 180,
