...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .moves = {MOVE_PSYCHIC, MOVE_DARK_PULSE, MOVE_ENERGY_BALL, MOVE_ICE_PUNCH},
    .abilityNums = 0
    },
    {
    .iv = 255,
    ...
    .moves = {MOVE_AQUA_TAIL, MOVE_AQUA_JET, MOVE_CRUNCH, MOVE_ICE_FANG},
    .abilityNums = 0
    },
    {
    .iv = 255,
    ...
    .moves = {MOVE_NIGHT_SLASH, MOVE_IRON_HEAD, MOVE_PSYCHO_CUT, MOVE_X_SCISSOR},
    .abilityNums = 0
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_MOONBLAST, MOVE_MYSTICAL_FIRE, MOVE_PSYCHIC},
    .abilityNums = 1
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SHADOW_BALL, MOVE_DARK_PULSE, MOVE_HEX, MOVE_WILL_O_WISP},
    .abilityNums = 0
    },
    {
    .iv = 255,
    ...
    .moves = {MOVE_THUNDERBOLT, MOVE_HYDRO_PUMP, MOVE_SHADOW_BALL, MOVE_PAIN_SPLIT},
    .abilityNums = 0
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_WISE_GLASSES,
    .moves = {MOVE_SHADOW_BALL, MOVE_SLUDGE_WAVE, MOVE_FOCUS_BLAST, MOVE_HYPNOSIS},
    .abilityNums = 0
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BLIZZARD, MOVE_ICE_SHARD, MOVE_EARTH_POWER, MOVE_GIGA_DRAIN},
    .abilityNums = 0
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_FOCUS_BAND,
    .moves = {MOVE_SPIKES, MOVE_CRUNCH, MOVE_ICICLE_CRASH, MOVE_ZEN_HEADBUTT},
    .abilityNums = 0
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_WISE_GLASSES,
    .moves = {MOVE_ICE_BEAM, MOVE_SHADOW_BALL, MOVE_DRAINING_KISS, MOVE_WILL_O_WISP},
    .abilityNums = 1
    },
    {
    .iv = 250,
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DRAGON_CLAW, MOVE_DUAL_WINGBEAT, MOVE_EXTREME_SPEED, MOVE_FIRE_PUNCH},
    .abilityNums = 1
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_SCOPE_LENS,
    .moves = {MOVE_SURF, MOVE_DRAGON_PULSE, MOVE_FLASH_CANNON, MOVE_ICE_BEAM},
    .abilityNums = 1
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_HEAT_WAVE, MOVE_DRAGON_PULSE, MOVE_SOLAR_BEAM, MOVE_EARTHQUAKE},
    .abilityNums = 1
    },
    {
    .iv = 255,
    ...
    .moves = {MOVE_HEAD_SMASH, MOVE_DRAGON_CLAW, MOVE_FIRE_FANG, MOVE_DUAL_WINGBEAT},
    .abilityNums = 0
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_IRON_HEAD, MOVE_BODY_PRESS, MOVE_ROCK_SLIDE},
    .abilityNums = 0
    },
    {
    .iv = 255,
    ...
    .species = SPECIES_SOLROCK,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_FLARE_BLITZ, MOVE_ZEN_HEADBUTT, MOVE_ENERGY_BALL, MOVE_BULLDOZE},
    .abilityNums = 0
    },
    {
    .iv = 255,
    ...
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_POWER_GEM, MOVE_SHADOW_BALL, MOVE_ENERGY_BALL},
    .abilityNums = 0
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SCALD, MOVE_AIR_SLASH, MOVE_PROTECT, MOVE_ICE_BEAM},
    .abilityNums = 0
    },
    {
    .iv = 200,
    ...
    .species = SPECIES_WALREIN,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SURF, MOVE_BODY_SLAM, MOVE_ICE_BEAM, MOVE_WATER_PULSE},
    .abilityNums = 0
    },
    {
    .iv = 200,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SURF, MOVE_ICE_BEAM, MOVE_SCALD, MOVE_PROTECT},
    .abilityNums = 0
    },
    {
    .iv = 200,
    ...
    .moves = {MOVE_PSYCHIC, MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_SHADOW_BALL},
    .abilityNums = 0
    },
    {
    .iv = 250,
...
static const struct TrainerMonItemCustomMoves sParty_Steven_Champion[] = {
    {
    .iv = 255,
    .lvl = 57,
    ...
    .heldItem = ITEM_WISE_GLASSES,
    .moves = {MOVE_SURF, MOVE_FLASH_CANNON, MOVE_ICE_BEAM, MOVE_AIR_SLASH},
    .abilityNums = 0
    },
    {
    .iv = 255,
    ...
    .moves = {MOVE_HEAD_SMASH, MOVE_IRON_HEAD, MOVE_THUNDER_WAVE, MOVE_EARTHQUAKE},
    .abilityNums = 1
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_LEECH_LIFE, MOVE_ROCK_SLIDE, MOVE_BRICK_BREAK, MOVE_AERIAL_ACE},
    .abilityNums = 1
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_SALAC_BERRY,
    .moves = {MOVE_BULLET_PUNCH, MOVE_POUNCE, MOVE_AERIAL_ACE, MOVE_VINE_WHIP},
    .abilityNums = 1
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMoves sParty_MayRoute110Mudkip[] = {
    ...
    .moves = {MOVE_WING_ATTACK, MOVE_QUICK_ATTACK, MOVE_STEEL_WING, MOVE_SWIFT},
    .abilityNums = 1,
    },
    {
    .iv = 100,
    ...
    .moves = {MOVE_BULLDOZE, MOVE_HEADBUTT, MOVE_ROCK_SLIDE, MOVE_METAL_CLAW},
    .abilityNums = 1,
    },
    {
    .iv = 100,
    ...
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_FIRE_FANG, MOVE_COVET, MOVE_HEADBUTT, MOVE_BITE},
    .abilityNums = 0,
    },
    {
    .iv = 100,
    ...
    .species = SPECIES_STARYU,
    .heldItem = ITEM_MYSTIC_WATER,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_AURORA_BEAM, MOVE_PSYBEAM, MOVE_RAPID_SPIN},
    .abilityNums = 1,
    },
    {
    .iv = 100,
    ...
    .species = SPECIES_GROVYLE,
    .heldItem = ITEM_MIRACLE_SEED,
    .moves = {MOVE_DOUBLE_KICK, MOVE_MEGA_DRAIN, MOVE_DRAGON_BREATH, MOVE_QUICK_ATTACK},
    .abilityNums = 1,
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_MayRoute110Treecko[] = {
    ...
    .species = SPECIES_ROSELIA,
    .heldItem = ITEM_MIRACLE_SEED,
    .moves = {MOVE_MAGICAL_LEAF, MOVE_SYNTHESIS, MOVE_SLUDGE, MOVE_LEECH_SEED},
    .abilityNums = 1,
    },
    {
    .iv = 100,
    ...
    .species = SPECIES_COMBUSKEN,
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_DOUBLE_KICK, MOVE_AERIAL_ACE, MOVE_FLAME_WHEEL, MOVE_QUICK_ATTACK},
    .abilityNums = 1,
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_MayRoute110Torchic[] = {
    ...
    .moves = {MOVE_BULLDOZE, MOVE_WATER_PULSE, MOVE_ROCK_SLIDE, MOVE_ICE_PUNCH},
    .abilityNums = 0,
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRustboroTreecko[] = {
    ...
    .moves = {MOVE_ASTONISH, MOVE_GUST, MOVE_WING_ATTACK, MOVE_PURSUIT},
    .abilityNums = 1
    },
    {
    .iv = 100,
    ...
    .species = SPECIES_BUIZEL,
    .heldItem = ITEM_MYSTIC_WATER,
    .moves = {MOVE_WATER_GUN, MOVE_WATER_PULSE, MOVE_QUICK_ATTACK, MOVE_BITE},
    .abilityNums = 0
    },
    {
    .iv = 100,
    ...
    .heldItem = ITEM_MIRACLE_SEED,
    .moves = {MOVE_MEGA_DRAIN, MOVE_HYPNOSIS, MOVE_CONFUSION, MOVE_LEECH_SEED},
    .abilityNums = 0
    },
    {
    .iv = 150,
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRustboroMudkip[] = {
    ...
    .species = SPECIES_VULPIX,
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_FLAME_WHEEL, MOVE_NIGHT_SHADE, MOVE_QUICK_ATTACK, MOVE_WILL_O_WISP},
    .abilityNums = 0
    },
    {
    .iv = 100,
...
static const struct TrainerMonItemCustomMoves sParty_TabithaMtChimney[] = {
    ...
    .moves = {MOVE_CRUNCH, MOVE_POISON_FANG, MOVE_MEGA_DRAIN, MOVE_WING_ATTACK},
    .abilityNums = 0
    },
    {
    .iv = 150,
    ...
    .moves = {MOVE_EARTH_POWER, MOVE_FLAMETHROWER, MOVE_ANCIENT_POWER, MOVE_REST},
    .abilityNums = 1
    },
    {
    .iv = 150,
    ...
    .species = SPECIES_MAGCARGO,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_ROCK_SLIDE, MOVE_BODY_SLAM, MOVE_YAWN, MOVE_ROLLOUT},
    .abilityNums = 1
    },
    {
    .iv = 150,
...
static const struct TrainerMonItemCustomMoves sParty_MayRustboroMudkip[] = {
    ...
    .heldItem = ITEM_SILK_SCARF,
    .moves = {MOVE_QUICK_ATTACK, MOVE_PECK, MOVE_SWIFT, MOVE_TACKLE},
    .abilityNums = 1
    },
    {
    .iv = 100,
    ...
    .species = SPECIES_GROWLITHE,
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_FLAME_WHEEL, MOVE_BITE, MOVE_HEADBUTT, MOVE_EMBER},
    .abilityNums = 0
    },
    {
    .iv = 100,
...
static const struct TrainerMonItemCustomMoves sParty_MaxieMtChimney[] = {
    ...
    .species = SPECIES_CROBAT,
    .heldItem = ITEM_BRIGHT_POWDER,
    .moves = {MOVE_GIGA_DRAIN, MOVE_CRUNCH, MOVE_POISON_FANG, MOVE_DUAL_WINGBEAT},
    .abilityNums = 0
    },
    {
    .iv = 180,
    ...
    .heldItem = ITEM_FOCUS_BAND,
    .moves = {MOVE_FLAMETHROWER, MOVE_EARTH_POWER, MOVE_ICE_PUNCH, MOVE_THUNDER_PUNCH},
    .abilityNums = 0
    },
    {
    .iv = 180,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_GIGA_DRAIN, MOVE_ANCIENT_POWER, MOVE_SLUDGE_BOMB, MOVE_SUNNY_DAY},
    .abilityNums = 1
    },
    {
    .iv = 180,
...
static const struct TrainerMonItemCustomMoves sParty_WallyMauville[] = {
    ...
    .species = SPECIES_STARAVIA,
    .heldItem = ITEM_SILK_SCARF,
    .moves = {MOVE_QUICK_ATTACK, MOVE_AERIAL_ACE, MOVE_FACADE, MOVE_MUD_SLAP},
    .abilityNums = 0
    },
    {
    .iv = 150,
...
static const struct TrainerMonNoItemCustomMoves sParty_TyraAndIvy[] = {
    ...
    .moves = {MOVE_MACH_PUNCH, MOVE_ROCK_SMASH, MOVE_BULK_UP, MOVE_QUICK_ATTACK}
    },
    {
    .iv = 100,
    .lvl = 27,
    .species = SPECIES_SEALEO,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_AURORA_BEAM, MOVE_HEADBUTT, MOVE_ICE_BALL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_MayRustboroTreecko[] = {
    ...
    .species = SPECIES_ROSELIA,
    .heldItem = ITEM_MIRACLE_SEED,
    .moves = {MOVE_MEGA_DRAIN, MOVE_MAGICAL_LEAF, MOVE_ACID, MOVE_LEECH_SEED},
    .abilityNums = 1
    },
    {
    .iv = 150,
