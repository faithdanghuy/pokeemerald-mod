const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_BURMY_P] = _("Burmy"),
    [SPECIES_BURMY_S] = _("Burmy"),
    [SPECIES_BURMY_T] = _("Burmy"),
    [SPECIES_WORMADAM_P] = _("Wormadam"),
    [SPECIES_WORMADAM_S] = _("Wormadam"),
    [SPECIES_WORMADAM_T] = _("Wormadam"),
    ...
    [SPECIES_SHELLOS_E] = _("Shellos"),
    [SPECIES_GASTRODON_E] = _("Gastrodon"),
    [SPECIES_SHELLOS_W] = _("Shellos"),
    [SPECIES_GASTRODON_W] = _("Gastrodon"),
