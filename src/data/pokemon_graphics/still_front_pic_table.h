...
// Gen III
    ...
    SPECIES_SPRITE(BURMY_P,       gMonStillFrontPic_BurmyPlant),
    SPECIES_SPRITE(BURMY_S,       gMonStillFrontPic_BurmySandy),
    SPECIES_SPRITE(BURMY_T,       gMonStillFrontPic_BurmyTrash),
    SPECIES_SPRITE(WORMADAM_P,    gMonStillFrontPic_WormadamPlant),
    SPECIES_SPRITE(WORMADAM_S,    gMonStillFrontPic_WormadamSandy),
    SPECIES_SPRITE(WORMADAM_T,    gMonStillFrontPic_WormadamTrash),
    ...
    SPECIES_SPRITE(SHELLOS_E,     gMonStillFrontPic_ShellosEast),
    SPECIES_SPRITE(GASTRODON_E,   gMonStillFrontPic_GastrodonEast),
    SPECIES_SPRITE(SHELLOS_W,     gMonStillFrontPic_ShellosWest),
    SPECIES_SPRITE(GASTRODON_W,   gMonStillFrontPic_GastrodonWest),
    ...
    SPECIES_SPRITE(ROTOM_FAN,     gMonStillFrontPic_RotomFan),
    SPECIES_SPRITE(ROTOM_FROST,   gMonStillFrontPic_RotomFrost),
    SPECIES_SPRITE(ROTOM_HEAT,    gMonStillFrontPic_RotomHeat),
    SPECIES_SPRITE(ROTOM_MOW,     gMonStillFrontPic_RotomMow),
    SPECIES_SPRITE(ROTOM_WASH,    gMonStillFrontPic_RotomWash),
