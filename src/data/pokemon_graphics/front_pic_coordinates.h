...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_TURTWIG]     = { .size = MON_COORDS_SIZE(32, 40), .y_offset = 14 },
    [SPECIES_GROTLE]      = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 10 },
    [SPECIES_TORTERRA]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
