const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(BURMY_P, gMonPalette_BurmyPlant),
    SPECIES_PAL(BURMY_S, gMonPalette_BurmySandy),
    SPECIES_PAL(BURMY_T, gMonPalette_BurmyTrash),
    SPECIES_PAL(WORMADAM_P, gMonPalette_WormadamPlant),
    SPECIES_PAL(WORMADAM_S, gMonPalette_WormadamSandy),
    SPECIES_PAL(WORMADAM_T, gMonPalette_WormadamTrash),
    ...
    SPECIES_PAL(SHELLOS_E, gMonPalette_ShellosEast),
    SPECIES_PAL(GASTRODON_E, gMonPalette_GastrodonEast),
    SPECIES_PAL(SHELLOS_W, gMonPalette_ShellosWest),
    SPECIES_PAL(GASTRODON_W, gMonPalette_GastrodonWest),
