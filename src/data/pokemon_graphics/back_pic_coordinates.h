...
const struct MonCoords gMonBackPicCoords[] =
{
    ...
    [SPECIES_CHARIZARD]   = { .size = MON_COORDS_SIZE(64, 65), .y_offset =  1 },
    ...
    [SPECIES_STARAVIA]    = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  6 },
    ...
    [SPECIES_BURMY_P]     = { .size = MON_COORDS_SIZE(40, 56), .y_offset =  6 },
    [SPECIES_BURMY_S]     = { .size = MON_COORDS_SIZE(32, 56), .y_offset =  7 },
    [SPECIES_BURMY_T]     = { .size = MON_COORDS_SIZE(40, 64), .y_offset =  0 },  
    [SPECIES_WORMADAM_P]  = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  2 },
    [SPECIES_WORMADAM_S]  = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  2 },
    [SPECIES_WORMADAM_T]  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    ...
    [SPECIES_CHERRIM]     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_SHELLOS_E]   = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  8 },
    [SPECIES_GASTRODON_E] = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  3 },
    [SPECIES_SHELLOS_W]   = { .size = MON_COORDS_SIZE(40, 56), .y_offset =  8 },
    [SPECIES_GASTRODON_W] = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  3 },
