...
const struct MonCoords gMonBackPicCoords[] =
{
    ...
    [SPECIES_TURTWIG]     = { .size = MON_COORDS_SIZE(48, 32), .y_offset = 16 },
    [SPECIES_GROTLE]      = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 11 },
    [SPECIES_TORTERRA]    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
