const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(BURMY_P, gMonFrontPic_BurmyPlant),
    SPECIES_SPRITE(BURMY_S, gMonFrontPic_BurmySandy),
    SPECIES_SPRITE(BURMY_T, gMonFrontPic_BurmyTrash),
    SPECIES_SPRITE(WORMADAM_P, gMonFrontPic_WormadamPlant),
    SPECIES_SPRITE(WORMADAM_S, gMonFrontPic_WormadamSandy),
    SPECIES_SPRITE(WORMADAM_T, gMonFrontPic_WormadamTrash),
    ...
    SPECIES_SPRITE(SHELLOS_E, gMonFrontPic_ShellosEast),
    SPECIES_SPRITE(GASTRODON_E, gMonFrontPic_GastrodonEast),
    SPECIES_SPRITE(SHELLOS_W, gMonFrontPic_ShellosWest),
    SPECIES_SPRITE(GASTRODON_W, gMonFrontPic_GastrodonWest),
