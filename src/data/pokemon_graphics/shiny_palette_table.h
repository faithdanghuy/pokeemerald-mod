const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(BURMY_P, gMonShinyPalette_BurmyPlant),
    SPECIES_SHINY_PAL(BURMY_S, gMonShinyPalette_BurmySandy),
    SPECIES_SHINY_PAL(BURMY_T, gMonShinyPalette_BurmyTrash),
    SPECIES_SHINY_PAL(WORMADAM_P, gMonShinyPalette_WormadamPlant),
    SPECIES_SHINY_PAL(WORMADAM_S, gMonShinyPalette_WormadamSandy),
    SPECIES_SHINY_PAL(WORMADAM_T, gMonShinyPalette_WormadamTrash),
    ...
    SPECIES_SHINY_PAL(SHELLOS_E, gMonShinyPalette_ShellosEast),
    SPECIES_SHINY_PAL(GASTRODON_E, gMonShinyPalette_GastrodonEast),
    SPECIES_SHINY_PAL(SHELLOS_W, gMonShinyPalette_ShellosWest),
    SPECIES_SHINY_PAL(GASTRODON_W, gMonShinyPalette_GastrodonWest),
