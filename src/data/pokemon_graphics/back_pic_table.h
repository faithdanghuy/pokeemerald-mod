const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(BURMY_P, gMonBackPic_BurmyPlant),
    SPECIES_SPRITE(BURMY_S, gMonBackPic_BurmySandy),
    SPECIES_SPRITE(BURMY_T, gMonBackPic_BurmyTrash),
    SPECIES_SPRITE(WORMADAM_P, gMonBackPic_WormadamPlant),
    SPECIES_SPRITE(WORMADAM_S, gMonBackPic_WormadamSandy),
    SPECIES_SPRITE(WORMADAM_T, gMonBackPic_WormadamTrash),
    ...
    SPECIES_SPRITE(SHELLOS_E, gMonBackPic_ShellosEast),
    SPECIES_SPRITE(GASTRODON_E, gMonBackPic_GastrodonEast),
    SPECIES_SPRITE(SHELLOS_W, gMonBackPic_ShellosWest),
    SPECIES_SPRITE(GASTRODON_W, gMonBackPic_GastrodonWest),
