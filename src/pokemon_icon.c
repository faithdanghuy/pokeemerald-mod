...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_BURMY_P] = gMonIcon_BurmyPlant,
    [SPECIES_BURMY_S] = gMonIcon_BurmySandy,
    [SPECIES_BURMY_T] = gMonIcon_BurmyTrash,
    [SPECIES_WORMADAM_P] = gMonIcon_WormadamPlant,
    [SPECIES_WORMADAM_S] = gMonIcon_WormadamSandy,
    [SPECIES_WORMADAM_T] = gMonIcon_WormadamTrash,
    ...
    [SPECIES_SHELLOS_E] = gMonIcon_ShellosEast,
    [SPECIES_GASTRODON_E] = gMonIcon_GastrodonEast,
    [SPECIES_SHELLOS_W] = gMonIcon_ShellosWest,
    [SPECIES_GASTRODON_W] = gMonIcon_GastrodonWest,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_BURMY_S] = 1,
    [SPECIES_BURMY_T] = 0,
    [SPECIES_WORMADAM_P] = 1,
    [SPECIES_WORMADAM_S] = 1,
    [SPECIES_WORMADAM_T] = 0,
    [SPECIES_MOTHIM] = 0,
    [SPECIES_COMBEE] = 0,
    [SPECIES_VESPIQUEN] = 0,
    [SPECIES_PACHIRISU] = 0,
    ...
    [SPECIES_CHERRIM] = 1,
    [SPECIES_SHELLOS_E] = 0,
    [SPECIES_GASTRODON_E] = 0,
    [SPECIES_SHELLOS_W] = 0,
    [SPECIES_GASTRODON_W] = 0,
    [SPECIES_AMBIPOM] = 2,
    [SPECIES_DRIFLOON] = 2,
    [SPECIES_DRIFBLIM] = 2,
    [SPECIES_BUNEARY] = 2,
