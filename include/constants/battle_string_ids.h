...
#define STRINGID_PKMNSXWHIPPEDUPHAILSTORM   382
#define STRINGID_PKMNSXLOSTHPALITTLE        383
#define STRINGID_PKMNHEALBYPOISON           384
#define STRINGID_PKMNSTURDYENDUREDHIT       385
