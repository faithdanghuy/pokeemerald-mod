...
#define ITEM_MUSCLE_BAND 91
#define ITEM_WISE_GLASSES 92
...
|| (item) == ITEM_UP_GRADE || (item) == ITEM_DEEP_SEA_SCALE || (item) == ITEM_DEEP_SEA_TOOTH)
